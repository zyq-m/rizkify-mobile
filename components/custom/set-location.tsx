...
// import { SearchLocation, Coordinates, RangeOption } from '@/types/location';
...
export default function SetSearchLocationModal({
  ...
  const handleSaveLocation = async (): Promise<void> => {
    ...
    try {
      ...
      if (userId) {
        // await updateUserLocation({ userId, ...searchLocation });
      ...
      Alert.alert(
        'Location Saved',
        `You'll see items within ${searchLocation.range}km of this location`,
        [
          {
            text: 'OK',
            onPress: onClose,
            ...
            <Pressable
              ...
              {saving ? (
                ...
                <Text className="text-base font-semibold text-white">
                  {searchLocation ? 'Save Location' : 'Select Location'}
                </Text>
              )}
            </Pressable>
          </View>
